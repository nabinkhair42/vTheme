          ...
          >
            <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-lg backdrop-blur-sm">
              ...
              {installMethod === "marketplace" && (
                <div className="space-y-5">
                  <p className="text-sm text-muted-foreground">
                    Install directly from the VS Code marketplace with just a
                    few clicks. The easiest method for most users.
                  </p>
                  ...
                  <ol className="space-y-4 text-sm">
                    <li className="flex gap-3">
                      ...
                      <span>
                        ...
                        <strong>Extensions</strong> icon in the sidebar
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <div className="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full bg-primary/10 text-primary font-medium text-xs">
                      ...
                      <span>
                        Search for <strong>"V Theme"</strong> and click Install
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <div className="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full bg-primary/10 text-primary font-medium text-xs">
                      ...
                      <span>
                        Select V Theme from the Color Theme menu (
              ...
              {installMethod === "cli" && (
                <div className="space-y-5">
                  <p className="text-sm text-muted-foreground">
                    Use the VS Code CLI to install V Theme directly from your
                    terminal.
                  </p>
                  ...
                  <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-primary/5 text-sm">
                    ...
                    <p>
                      After installation, select V Theme from the Color Theme
                      menu (
                      <kbd className="px-1 py-0.5 rounded bg-muted text-xs">
                        Ctrl+K
                      </kbd>{" "}
                  ...
                  <div className="pt-3">
                    <Button className="w-full" size="lg" onClick={copyCommand}>
                      {copied ? (
              ...
              {installMethod === "github" && (
                <div className="space-y-5">
                  <p className="text-sm text-muted-foreground">
                    Clone the repository from GitHub and install manually. Best
                  ...
                  <ol className="space-y-4 text-sm">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span>
                        Restart VS Code and select V Theme from the Color Theme
                        menu
                      </span>
                    </li>
                  </ol>
